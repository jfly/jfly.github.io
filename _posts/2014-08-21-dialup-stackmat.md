...
{% include image-old.html src="dialup-stackmat/dan-cohen-signals.png" alt="Dan Cohen's distorted signal" %}
...
{% include image-old.html src="dialup-stackmat/1.15_iphone3gs.png" alt="Distorted signal on an iPhone 3Gs" %}
...
{% include image-old.html src="dialup-stackmat/Squarewave01CJC.png" alt='Components of a square wave. From <a href=\'http://en.wikipedia.org/wiki/File:Squarewave01CJC.png\'>http://en.wikipedia.org/wiki/File:Squarewave01CJC.png</a>' %}
...
{% include image-old.html src="dialup-stackmat/no-filter.png" alt="Unfiltered stackmat signal" %}

{% include image-old.html src="dialup-stackmat/no-filter-analysis.png" alt="Unfiltered stackmat signal frequency analysis. Note the bias towards low frequency signals." %}
...
{% include image-old.html src="dialup-stackmat/band-pass-filter.png" alt="300 Hz - 3400 Hz band pass filter applied to stackmat signal" %}

{% include image-old.html src="dialup-stackmat/band-pass-filter-analysis.png" alt="300 Hz - 3400 Hz band pass filter frequency analysis. Note that a lot of the higher frequencies are gone, and the very lowest frequencies have dropped off." %}
...
{% include image-old.html src="dialup-stackmat/fsk.jpg" alt="<a href='http://ironbark.xtelco.com.au/subjects/DC/lectures/7/fig_2010_07_05.jpg'>FSK</a> encoding of a digital signal" %}
...
{% include image-old.html src="dialup-stackmat/2014-03-14 21.42.27.jpg" alt="Unboxing the DS8500 evaluation kit" %}
{% include image-old.html src="dialup-stackmat/2014-03-18 23.35.38.jpg" alt="Wiring up the DS8500. This was tricky!" %}
...
{% include image-old.html src="dialup-stackmat/stackmat-fsk-gerty-nexus5-iphone3gs.png" alt="Output of the DS8500 as recorded by my desktop (gerty), a Nexus 5, and an iPhone 3Gs. The top row is the incoming digital signal, the output of a generation 2 stackmat stopped at 0.00." %}
...
{% include image-old.html src="dialup-stackmat/FSKube_files/board_top.png" alt="Top view" %}
{% include image-old.html src="dialup-stackmat/FSKube_files/FSKube.brd.png" alt="Layout" %}
{% include image-old.html src="dialup-stackmat/FSKube_files/FSKube.sch.png" alt="Schematic" %}
...
{% include image-old.html src="dialup-stackmat/board-fresh-from-osh-park.jpg" alt="A board fresh from OSH park" %}
...
{% include image-old.html src="dialup-stackmat/2014-04-17 18.42.30.jpg" alt="Could this be any tinier please?" %}
...
{% include image-old.html src="dialup-stackmat/IMG_20140422_162324.jpg" alt="Boards with the DS8500 soldered on. Note that the lower right board is charred and cracked from the hot air treatment." %}

After that, it was a simple matter of letting Eithan do all the work.

{% include image-old.html src="dialup-stackmat/IMG_20140422_183302.jpg" alt="Eithan soldering the through hole components." %}
{% include image-old.html src="dialup-stackmat/IMG_20140422_190723.jpg" alt="Military precision" %}
...
{% include image-old.html src="dialup-stackmat/finished-board.jpg" alt="The finished board." %}
